...
lang en_US.UTF-8
keyboard us
network --onboot=yes --device=eth0 --bootproto=static --ip=192.168.50.80 --netmask=255.255.255.0 --gateway=192.168.50.1 --nameserver=192.168.50.1 --noipv6 --hostname=grapher.atomiclab.local
firewall --disabled
